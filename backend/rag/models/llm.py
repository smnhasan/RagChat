...
class LLM(BaseLLM, PydanticBaseModel):
    """
    Custom LLM class using local LlamaModel instead of API.
    """
    ...
    def __init__(self, **kwargs):
        ...
        if self.model is None:
            # Initialize LlamaModel with default config
            config = ModelConfig()
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        """
        Call the local LlamaModel with the given prompt.
        """
        try:
            ...
            raise ValueError(f"LlamaModel generation failed: {e}")
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        return {"model_id": self.model.config.model_id}
